                ...
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Edit</strong> Mahasiswa Angkatan 2018
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_mahasiswa_2018" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <input type="hidden" name="id_mahasiswa" value="<?php echo $id_mahasiswa ?>">
                            <input type="hidden" name="kelas" value="2018">
