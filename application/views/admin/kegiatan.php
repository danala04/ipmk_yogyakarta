    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-12">
            <div class="animated fadeIn">
                <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url()?>admin/tambah_kegiatan"><button class="btn btn-info">Tambah</button></a><br><br>
                </div>
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Kegiatan IPMK YOGYAKARTA</strong>
                        </div>
                        ...
                        <div class="card-body">
                          <table id="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <?php $no = 0; foreach($data_kegiatan as $row) 
                            { 
                                $no++;
                            ?>
                              <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>admin/edit_kegiatan/<?php echo $row['id_kegiatan']; ?>" data-toggle="tooltip" data-placement="top" title="EDIT">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/hapus_kegiatan/<?php echo $row['id_kegiatan']; ?>" data-toggle="tooltip" data-placement="top" title="HAPUS">
