...
<head>
    ...
    <title>Admin | SMA NEGERI 1 Rimbo Bujang</title>
                ...
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Import</strong> Data Siswa Angkatan 2018
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/upload_mahasiswa_2018" method="post" enctype="multipart/form-data" class="form-horizontal">
