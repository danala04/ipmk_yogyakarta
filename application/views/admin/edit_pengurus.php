    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-12">
            <div class="animated fadeIn">
                <div class="row">
                <div class="col-md-8">
                    <a href="<?php echo base_url()?>admin/pengurus"><button class="btn btn-info">Kembali</button></a><br><br>
                </div>
                
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Edit</strong> Pengurus
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_pengurus" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <input type="hidden" name="id_pengurus" value="<?php echo $id_pengurus ?>">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" value="<?php echo $ttl ?>" name="ttl" placeholder="ttl" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" value="<?php echo $alamat_kuningan?>" name="alamat_kuningan" placeholder="alamat_kuningan" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" value="<?php echo $no_hp?>" name="no_hp" placeholder="no_hp" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" value="<?php echo $jurusan?>" name="jurusan" placeholder="jurusan" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" value="<?php echo $universitas?>" name="universitas" placeholder="universitas" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" value="<?php echo $angkatan?>" name="angkatan" placeholder="angkatan" class="form-control">
                                </div>
                              </div>
