    ...
    <div id_siswa="right-panel" class="right-panel">
        ...
        <div class="content mt-12">
            <div class="animated fadeIn">
                <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url()?>admin/tambah_mahasiswa_2019"><button class="btn btn-info">Tambah</button></a><br><br>
                </div>
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Mahaiswa Angkatan 2019</strong>
                        </div>
                        ...
                        <div class="card-body">
                          <table id_siswa="bootstrap-data-table" class="table table-striped table-bordered">
                            ...
                            <tbody>
                            <?php $no = 0; foreach($mahasiswa_2019 as $row) 
                            { 
                                $no++;
                            ?>
                              <tr>
                                ...
                                <td>
                                    <a class="btn btn-info btn-sm" href="<?php echo base_url(); ?>admin/edit_mahasiswa_2019/<?php echo $row['id_mahasiswa']; ?>" data-toggle="tooltip" data-placement="top" title="EDIT">
                                        <i class="fa fa-edit"></i>
                                    </a>
                                    <a class="btn btn-danger btn-sm" href="<?php echo base_url(); ?>admin/hapus_mahasiswa_2019/<?php echo $row['id_mahasiswa']; ?>" data-toggle="tooltip" data-placement="top" title="HAPUS">
