                ...
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Tambah</strong> Pengurus
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/simpan_pengurus" method="post" enctype="multipart/form-data" class="form-horizontal">
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="ttl" placeholder="ttl" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="alamat_kuningan" placeholder="alamat_kuningan" class="form-control">
                                </div>
                              </div>
                              <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="no_hp" placeholder="no_hp" class="form-control">
                                </div>
                              </div>
                              <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="jurusan" placeholder="jurusan" class="form-control">
                                </div>
                               </div>
                               <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="universitas" placeholder="universitas" class="form-control">
                                </div>
                               </div>
                               <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="angkatan" placeholder="angkatan" class="form-control">
                                </div>
                               </div>
                               <div class="row form-group">
                                <div class="col col-md-3">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="jabatan" placeholder="jabatan" class="form-control">
                                </div>
                               </div>
                          </div>
