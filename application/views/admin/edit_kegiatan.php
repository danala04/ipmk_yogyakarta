    ...
    <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-12">
            <div class="animated fadeIn">
                <div class="row">
                <div class="col-md-12">
                    <a href="<?php echo base_url()?>admin/kegiatan"><button class="btn btn-info">Kembali</button></a><br><br>
                </div>
                
                <div class="col-md-12">
                    <div class="card">
                      <div class="card-header">
                        <strong>Edit</strong> Kegiatan
                      </div>
                      <div class="card-body card-block">
                        <form action="<?php echo base_url()?>admin/update_kegiatan" method="post" enctype="multipart/form-data" class="form-horizontal">
                            <input type="hidden" name="id_kegiatan" value="<?php echo $id_kegiatan ?>">
                             ...
                             <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="waktu" value="<?php echo $waktu?>" placeholder="waktu kegiatan" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="jam" value="<?php echo $jam?>" placeholder="jam" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" name="nama_kegiatan" value="<?php echo $nama_kegiatan?>" placeholder="nama kegiatan" class="form-control">
                                </div>
                              </div>
                              ...
                              <div class="row form-group">
                                ...
                                <div class="col-12 col-md-9">
                                    <input type="text" id="text-input" value="<?php echo $tempat?>" name="tempat" placeholder="tempat" class="form-control">
                                </div>
                              </div>
                          </div>
